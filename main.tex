...
\newcommand{\tool}{JRex}
\newcommand{\toolfull}{Java Region Explorer (JRex)}
...
\title{\tool: Higher-Order Static Regions for Efficient Symbolic Execution of Java}
\author[1]{}
...
search space of Java symbolic execution benchmarks, with our expanded
