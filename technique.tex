...
Figure~\ref{fig:semantics} shows the semantics of different transformations, with evaluation following judgment where each step on some statement s, with respect to the maps $\Delta_r, \Delta_s, \Gamma_r, \Gamma_s, \Psi, \Sigma, \Sigma_{ret}$, yields a new statement $s'$ and possibly new maps $\Delta_r', \Delta_s', \Gamma_r', \Gamma_s', \Psi', \Sigma', \Sigma_{ret}'$ in some transformation $T$.

$\step{\Delta_r, \Delta_s, \Gamma_r, \Gamma_s, \Psi, \Sigma, \Sigma_{ret}}{s}{\Delta_r', \Delta_s', \Gamma_r', \Gamma_s', \Psi', \Sigma', \Sigma_{ret}'}{s'}{T}$
