...
\infer[\rn{substitution}]
 {\step{\Theta, \Delta_s}{x.s}{\Theta, \Delta_s}{\sub{(v,e)}{x}{s}}}
 {\lookup{\Theta}{x} = l , \quad \lookup{\Delta_s}{l}=(v,e)}
\qquad 
\infer[\rn{high-order_1}]
 {\step{\Gamma_r, \Delta_r}{s_1; invoke(e_1, e_2)}{(\Gamma_r \cup \Gamma_r'), \Delta_r''}{s_1; \sub{v_2}{x}{s_1}}}
 {\step{\Gamma_r, \Delta_r}{e_1}{\Gamma_r, \Delta_r'}{v} \quad \lookup{\Gamma_s}{v} = \tau , \quad \Gamma_r', \lookup{\Psi}{\tau}=x.s_2, \quad \step{\Delta_r'}{e_2}{\Delta_r''}{v_2}}
$$
$$
\infer[\rn{high-order_2}]
 {\step{\Gamma_r, \Delta_r}{e = invoke(e_1, e_2)}{(\Gamma_r \cup \Gamma_r'), \Delta_r''}{\sub{v_2}{x}{s} ; e = e'}}
 {\step{\Gamma_r, \Delta_r}{e_1}{\Gamma_r', \Delta_r'}{v}, \quad \lookup{\Gamma_s}{v} = \tau, \quad \Gamma_r', \lookup{\Psi}{\tau}=x.s; \return{e'}, \quad \step{\Delta_r'}{e_2}{\Delta_r''}{v_2}}
$$
$$
...
$$
$$
\infer[\rn{greenlization}]
 {\step{\Sigma}{x := gamma(e_1, e_2, e_3)}{\Sigma}{( e_1 \wedge x = e_2) \vee ( !e_1 \wedge x = e_3)}}
 {}
$$
$$
\infer[\rn{early-return_1}]
 {\step{\Sigma}{\ifr{e_1}{(s_1 ; \return{e_2})}{s_2}}{\Sigma \vee e_1}{\ifr{e_1}{(s_1 ; \return{e_2})}{s_2} ; x = e_2}}
 {gen\_id(\_) = x}
$$
$$
\infer[\rn{early-return_2}]
 {\step{\Sigma}{\ifr{e_1}{s_1}{(s_2 ; \return{e_2})}}{\Sigma \vee !e_1}{\ifr{e_1}{(s_1 ; \return{e_2})}{s_2} ; x := e_2}}
 {gen\_id(\_) = x}
$$
$$
\infer[\rn{early-return_3}]
 {\step{\Sigma}{\ifr{e}{(s_1 ; \return{e_1})}{(s_2 ; \return{e_2})}}{\Sigma \vee true}{\ifr{e}{(s_1 ; \return{e_1})}{(s_2 ; \return{e_2})} ; x := gamma(e1, e_2, e_3)}}
 {gen\_id(\_) = x}
$$
}}
...
Input: Region R
 ...
 \Repeat{!(somethingChanged)}
 {
	...
	populate output\;
 \caption{Ranger Algorithm for Altering Transformations}
\end{algorithm}
