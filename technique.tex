...
In the following sections, we describe the semantics of Java Ranger\rq s transformations
...
<canonical-exp> ::= <val> | <var> 
\alt <canonical-exp> $op_b$ <canonical-exp> | $op_u$ <canonical-exp>
\alt gamma( <canonical-exp>, <canonical-exp>, <canonical-exp> )
