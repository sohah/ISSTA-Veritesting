...
resolved to a concrete integer value 375 to change the statement to {\tt x44\$2= invoke(ArrayList.get(I)Ljava.lang.Object,375, x59\$2);}\\
...
summary of {\tt Integer.intValue()}) produces the following statement.
%
Please note that the {\tt value} field accessed by {\tt Integer.intValue()} in the object referenced by the value
380 was set to the symbolic integer {\tt x1}.
\begin{lstlisting}
