...
Figure~\ref{fig:semantics} shows the semantics of different transformations, with evaluation following judgment where each step on some statement s, with respect to the maps above yields a new statement $s'$ and possibly new maps in some transformation $T$.
