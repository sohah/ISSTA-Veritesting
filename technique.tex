...
%
\textbf{Value-map}: $\Delta_r$ and $\Delta_s$ maps stack slots, to concrete $val$ or symbolic $exp$ for Java Ranger and DSE respectively. This is used to collect the input of the region as well as to populate the output of the region.\\
