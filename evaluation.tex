...
\vaibhav{Vaibhav: can you check out this table.\\}
% \begin{table}[h]
%     \begin{tabular}{@{}ccccc@{}}
%         \toprule
...
\begin{figure}[]%
    ...
    running time by 86\%. While vanilla SPF (which is mode 1 in \tool) times out in 12 hours with 7 symbolic inputs, \tool\
    ...
    Vanilla SPF (which is mode 1 in \tool) still times out in 12 hours with 8 symbolic inputs (including the {\tt stopOnNonOption}
