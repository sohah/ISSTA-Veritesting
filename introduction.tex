...
\begin{figure}
    ...
    \caption{An example demonstrating the need for using a multi-path region summary for two regions}
...
{\tt ArrayList<Integer>.get(int)} which internally does the following:
%
